...
const translations: Translations = {
  tr: {
    ...
    'home.section1.description': 'İhtiyacınıza özel, sade ve işlevsel yazılım çözümleri geliştiriyorum. Web siteleri, mobil uygulamalar, otomasyon sistemleri ve veri yönetimi gibi alanlarda sizinle birlikte çalışıyor; süreci analiz ediyor, en uygun çözümü tasarlayıp hayata geçiriyorum.\n\nTek bir kişiyle çalışmanın avantajıyla hızlı iletişim, esnek çözümler ve doğrudan sonuç odaklı ilerliyorum.',
    ...
    'portfolio.completed.project1.description': 'Modern Stok Yönetim Sistemi\n\n🛠 Kullanılan Teknolojiler:\nReact · Node.js · TypeScript · MongoDB · AWS\n\n📦 Projenin Kapsamı ve Amaçları:\nKüçük ve orta ölçekli işletmeler için geliştirilen, kullanıcı dostu bir stok yönetim sistemi. Stok takibi, sipariş yönetimi ve raporlama özellikleriyle işletmelerin operasyonel süreçlerini optimize ediyor.\n\nSistemin Ana Özellikleri:\n• Gerçek Zamanlı Stok Takibi\n• Sipariş Yönetimi\n• Tedarikçi Entegrasyonu\n• Raporlama Araçları\n• Çoklu Kullanıcı Desteği\n\n🚀 Kazanımlar ve Başarılar:\n• %40 daha verimli stok yönetimi\n• Sipariş süreçlerinde hızlanma\n• Maliyet optimizasyonu\n• Veri güvenliği\n\n📈 Etki ve Sonuçlar:\n• Stok kayıplarında azalma\n• Operasyonel verimlilikte artış\n• Müşteri memnuniyetinde iyileşme',
    'portfolio.completed.project2.title': 'Ekşiler Studio Oyun Projesi',
    'portfolio.completed.project2.description': 'Unity ve C# ile Geliştirilen Oyun Projesi\n\n🛠 Kullanılan Teknolojiler:\nUnity · C# · Blender · Photoshop\n\n📦 Projenin Kapsamı ve Amaçları:\nSteam platformunda yayınlanan, 3D modelleme ve interaktif medya özellikleri içeren bir oyun projesi. Kullanıcı deneyimini ön planda tutan, yaratıcı bir oyun deneyimi sunuyor.\n\nProjenin Ana Özellikleri:\n• 3D Karakter Modelleme\n• Fizik Motoru Entegrasyonu\n• Çok Oyunculu Mod\n• Başarım Sistemi\n• Steam Entegrasyonu\n\n🚀 Kazanımlar ve Başarılar:\n• Steam\'de 1000+ indirme\n• Olumlu kullanıcı yorumları\n• Topluluk desteği\n• Teknik başarı\n\n📈 Etki ve Sonuçlar:\n• Oyun geliştirme deneyimi\n• Topluluk oluşturma\n• Teknik beceri geliştirme',
    'portfolio.completed.project3.title': 'All R Studio Web Portalı',
    ...
    'contact.subjectPlaceholder': 'Konu',
  ...
  en: {
    ...
    'home.section1.description': 'I develop custom, simple, and functional software solutions tailored to your needs. Working with you in areas such as websites, mobile applications, automation systems, and data management; I analyze the process, design the most suitable solution, and implement it.\n\nWith the advantage of working with a single person, I progress with fast communication, flexible solutions, and direct results.',
